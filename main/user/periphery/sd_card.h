...
#define PIN_NUM_MISO (GPIO_NUM_13) /*!< Pin number for MISO    */
#define PIN_NUM_MOSI (GPIO_NUM_11) /*!< Pin number for MOSI   */
#define PIN_NUM_CLK (GPIO_NUM_12)   /*!< Pin number for CLK    */
