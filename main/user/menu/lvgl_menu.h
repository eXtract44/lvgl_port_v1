...
enum nameOfObjects {
  ...
  BACKGROUND_POPUP_SETTINGS,
  BTN_UI_SETTINGS,
  
  BACKGROUND_POPUP_WEATHER,
  BTN_WEATHER_SETTINGS,
  BTN_CLOUSE_POPUP_WEATHER,
  BTN_OPEN_LIST_CITY_POPUP_WEATHER,
  LIST_CITYS_WEATHER,
  POPUP_WEATHER_CITY,
  ...
  KEYBOARD_WIFI_SSID,
  KEYBOARD_WIFI_PASS,
  KEYBOARD_WIFI_TEXT_AREA_SSID,
  KEYBOARD_WIFI_TEXT_AREA_PASS,
  BTN_KEYBOARD_SSID,
  BTN_KEYBOARD_PASS,
